...
current_categories2applicants=retrieve_all_records("categories2applicants", only_id=False)
...
while i<20: # this number defines how many new items will be created
  ...
  # breakpoint()
  invalid = any(current_c2a['applicant_id']==c2a_data['applicant_id'] and current_c2a['category_id']==c2a_data['category_id'] for current_c2a in current_categories2applicants)
  if invalid==False:

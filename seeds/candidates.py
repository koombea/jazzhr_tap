...
def create_candidates(items_to_create, hire_candidate=False):
  ...
  while i<items_to_create:
    ...
    invalid = any(current_a2j["applicant_id"]==applicants2job_data['applicant_id'] and current_a2j["job_id"]==applicants2job_data['job_id'] for current_a2j in current_applicants2jobs)
    if invalid==False:
      if hire_candidate: applicants2job_data["workflow_step_id"] = random.choice(["8947217", "8947218"])

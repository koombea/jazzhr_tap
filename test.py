...
singer.write_schema(stream_name="jazzhr_applicants_details",
...
for applicant_ in applicants:
  ...
  if type(applicant["comments"]) != list:
    applicant["comments"] = [applicant["comments"]]
  if len(applicant["comments"]) > 0:
    print(applicant)
